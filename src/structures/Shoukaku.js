...
export class ShoukakuHandler extends Shoukaku {
    constructor(client) {
        super(new Libraries.DiscordJS(client), client.config.lavalink.servers, client.config.lavalink.options);
        this.events = new EventManager(client, this, resolve(this.cwd, "src", "listeners", "player")).load();
